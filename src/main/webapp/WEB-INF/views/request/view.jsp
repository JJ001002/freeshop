			...
			<div class = "flex flex-justify-between marginbottom50">
				<div class = "buttonupdatefont flex text-center ">
					...
					<div class = "buttonboxview text-center marginright20"> 
						<a href = "/request/update/${item.number}" class = "buttonupdatefont paddingtop10 atextone"  onclick = "check_name_Sync()">
						수정
					</a>
					</div>
					<div class = "buttonboxview text-center">
					<a href = "/request/delete/${item.number}" class = "buttonupdatefont paddingtop10 atextone"  onclick = "check_name_Sync()">
						삭제
					</a>
					</div>
				</div>
